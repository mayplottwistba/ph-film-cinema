...
const whatsNew = [
  {
    ...
    version: "2.4",
    updates: [
      'External links for <span class="update-film-tag">Baconaua (2017)</span>, Ang Duyan ng Magiting (2023), and <span class="update-film-tag">Ang Duyan ng Magiting (2024)</span> are now available.'
    ],
  },
  {
    date: "08.20.26",
